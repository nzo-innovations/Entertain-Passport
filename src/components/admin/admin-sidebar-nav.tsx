...
const NAV: { label: string; href: string; icon: LucideIcon }[] = [
  ...
  { label: "Passport inventory", href: "/admin/passports", icon: Layers },
  { label: "Passports (NFC)", href: "/admin/nfc", icon: CreditCard },
  ...
  { label: "Seating layouts", href: "/admin/seating", icon: LayoutGrid },
